...
namespace Meadow.Units
{
    ...
    public class Distance : IUnitType, IComparable, IFormattable, IConvertible, IEquatable<double>, IComparable<double>
    {
        /// <summary>
        ...
        public Distance(double value, UnitType type = UnitType.Meters)
        {
            //always store reference value
            Unit = type;
            _value = DistanceConversions.Convert(value, type, UnitType.Meters);
        }

        /// <summary>
        /// The distance expressed as a value.
        /// </summary>
        public double Value {
            get => DistanceConversions.Convert(_value, UnitType.Meters, Unit);
            set => _value = DistanceConversions.Convert(value, Unit, UnitType.Meters);
        }
        ...
        /// <summary>
        /// The type of units available to describe the distance.
        /// </summary>
        ...
        public double Milimeters => From(UnitType.Milimeters);
        ...
        {
            return DistanceConversions.Convert(_value, UnitType.Meters, convertTo);
        }
        ...
        [Pure] public bool Equals(Distance other) => _value == other._value;

        [Pure] public override int GetHashCode() => _value.GetHashCode();

        [Pure] public static bool operator ==(Distance left, Distance right) => Equals(left, right);
        [Pure] public static bool operator !=(Distance left, Distance right) => !Equals(left, right);
        [Pure] public int CompareTo(Distance other) => Equals(this, other) ? 0 : _value.CompareTo(other._value);
        [Pure] public static bool operator <(Distance left, Distance right) => Comparer<Distance>.Default.Compare(left, right) < 0;
        [Pure] public static bool operator >(Distance left, Distance right) => Comparer<Distance>.Default.Compare(left, right) > 0;
        [Pure] public static bool operator <=(Distance left, Distance right) => Comparer<Distance>.Default.Compare(left, right) <= 0;
        [Pure] public static bool operator >=(Distance left, Distance right) => Comparer<Distance>.Default.Compare(left, right) >= 0;

        [Pure] public static implicit operator Distance(int value) => new Distance(value);

        [Pure]
        public static Distance operator +(Distance lvalue, Distance rvalue)
        {
            var total = lvalue.Meters + rvalue.Meters;
            return new Distance(total, UnitType.Meters);
        }
