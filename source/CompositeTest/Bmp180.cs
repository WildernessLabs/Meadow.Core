...
namespace CompositeTest
{
        ...
        ITemperatureSensor, IBarometricPressureSensor
    {
        ...
        public (Pressure Pressure, Temperature Temperature) Conditions;
        ...
        /// </summary>
        public Task<(Pressure Pressure, Temperature Temperature)> Read()
        {
            Update();
        ...
        public void StartUpdating(int standbyDuration = 1000)
        {
            ...
            lock (_lock)
            {
                ...
                (Pressure Pressure, Temperature Temperature) oldConditions;

                CompositeChangeResult<Pressure, Temperature> result;
                ...
                Task.Factory.StartNew(async () => {
                    while (true)
                    {
                        ...
                        oldConditions = (Conditions.Item1, Conditions.Item2);

                        // read
                        Update();

                        // build a new result with the old and new conditions
                        result = new CompositeChangeResult<Pressure, Temperature>(oldConditions, Conditions);
        ...
        private void Update()
        {
            ...
            Conditions.Temperature = new Temperature((float)((b5 + 8) >> 4) / 10);
            ...
            Conditions.Pressure = new Pressure(value, Pressure.UnitType.Bar);
        }
