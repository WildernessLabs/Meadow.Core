...
namespace Meadow.Core
{
    internal static partial class Interop
    {
        public static partial class Nuttx
        {
            ...
            {
                ConfigureSUCCESSFUL = (10),
                ConfigureUNDEFINED_OPTION = (-1),
                ConfigureTIM_NUMB_ILLEGAL = (-2),
                ConfigureCHAN_NUMB_ILLEGAL = (-3),
                ConfigurePORT_PIN_NOT_FOR_TIM = (-4),
                ConfigurePORT_PIN_TIM_CHAN_INVALID = (-5),
                ConfigureTIM_NOT_USABLE = (-6),
                ConfigureTIM_CHAN_IN_USE = (-7),
                ConfigureCHAN_MEM_ALLOC_FAILED = (-8),
                ConfigureCONFIGGPIO_ERR = (-9),
                ConfigureINIT_CHAN_HW_FAIL = (-10),
                ConfigureINIT_TIM_HW_FAIL = (-11),
                ReadSUCCESSFUL = (20),
                ReadNO_CHANS_ACTIVITY = (-21),
                ReadINVALID_TIMER_NUMB = (-22),
                ReadINVALID_CHANNEL_NUMB = (-23),
                ReadTIMER_ACCESS_NULL = (-24),
                ReadCHAN_NOT_CONFIG = (-25),
                ReadCHANNEL_DATA_NULL = (-26),
                ReadNO_CHANS_ACTIVE = (-27),
                ReadFREQ_INPUT_NOT_DETECTED = (-28),
